...
/*
     B->Animal;
*/
void c_generator_original::inheritance(c_symbol & symbol)
{
...
/*----------------------------------------------------------------------------*/
void c_generator_original::members(t_vector_class_member & vector_class_member)
{
  unsigned i_member = 0;
...
//first[B]    id[258]->[IDENTIFIER] text[B] type[265]->[CLASS_NAME] class_key[300]->[CLASS]
	...
	switch(symbol.class_key)
	{
		...
		case STRUCT:
			...
			break;
		default:
			printf("  error c_generator_original::classes() bad symbol.class_key\n");
//			exit(-1);
	}
